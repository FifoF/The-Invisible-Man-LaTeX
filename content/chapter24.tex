\label{ch:24}
\SetRectoHeadText{\addfontfeature{Letters=ResetAll,LetterSpace=0,Scale=0.9}\itshape The Plan That Failed}
\begin{ChapterStart}
\vspace*{2\nbs}

\ChapterTitle{CHAPTER\, TWENTY-FOUR}
\vspace{1.5\nbs}
\ChapterSubtitle{The Plan That Failed}
\end{ChapterStart}

\dropcap[lines=2,ante=“]{B}\kern-5pt\textsc{ut now},” said Kemp, with a side glance out of the window, what are we to do?”
