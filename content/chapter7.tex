\label{ch:07}
\SetRectoHeadText{\addfontfeature{Letters=ResetAll,LetterSpace=0,Scale=0.9}\itshape The Unveiling of the Stranger}
\begin{ChapterStart}
\vspace*{2\nbs}

\ChapterTitle{CHAPTER\, SEVEN}
\vspace{1.5\nbs}
\ChapterSubtitle{The Unveiling}
\vspace{0.75\nbs}
\ChapterSubtitle{of the Stranger}
\end{ChapterStart}

\dropcap[lines=2]{T}\kern-3pt\textsc{he stranger} went into the little parlour of the Coach and Horses about half-past five in the morning, and there he remained until near midday, the blinds down, the door shut, and none, after Hall’s repulse, venturing near him.
