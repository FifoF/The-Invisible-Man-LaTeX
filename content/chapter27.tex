\label{ch:27}
\SetRectoHeadText{\addfontfeature{Letters=ResetAll,LetterSpace=0,Scale=0.9}\itshape The Siege of Kemp’s House}
\begin{ChapterStart}
\vspace*{2\nbs}

\ChapterTitle{CHAPTER\, TWENTY-SEVEN}
\vspace{1.5\nbs}
\ChapterSubtitle{The Siege of}
\vspace{0.75\nbs}
\ChapterSubtitle{Kemp’s House}
\end{ChapterStart}

\dropcap[lines=2]{K}\kern-8pt\textsc{emp read a strange missive}, written in pencil on a greasy sheet of paper.
