\label{ch:15}
\SetRectoHeadText{\addfontfeature{Letters=ResetAll,LetterSpace=0,Scale=0.9}\itshape The Man Who Was Running}
\begin{ChapterStart}
\vspace*{2\nbs}

\ChapterTitle{CHAPTER\, FIFTEEN}
\vspace{1.5\nbs}
\ChapterSubtitle{The Man Who}
\vspace{0.75\nbs}
\ChapterSubtitle{Was Running}
\end{ChapterStart}

\dropcap[lines=2]{I}\kern-6pt\textsc{n the early evening time} Doctor Kemp was sitting in his study in the belvedere on the hill overlooking Burdock. It was a pleasant little room, with three windows, north, west, and south, and bookshelves covered with books and scientific publications, and a broad writing-table, and, under the north window, a microscope, glass slips, minute instruments, some cultures, and scattered bottles of reagents. Doctor Kemp’s solar lamp was lit, albeit the sky was still bright with the sunset light, and his blinds were up because there was no offence of peering outsiders to require them pulled down. Doctor Kemp was a tall and slender young man, with flaxen hair and a moustache almost white, and the work he was upon would earn him, he hoped, the fellowship of the Royal Society, so highly did he think of it.
