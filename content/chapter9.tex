\label{ch:09}
\SetRectoHeadText{\addfontfeature{Letters=ResetAll,LetterSpace=0,Scale=0.9}\itshape Mr. \kern-2ptThomas Marvel}
\begin{ChapterStart}
\vspace*{2\nbs}

\ChapterTitle{CHAPTER\, NINE}
\vspace{1.5\nbs}
\ChapterSubtitle{Mr. Thomas Marvel}
\end{ChapterStart}
...
{\addfontfeature{LetterSpace=-1.5}“I tell you, the whole business fair beats me,” said Mr. Marvel.}\looseness=-1
