\label{ch:12}
\SetRectoHeadText{\addfontfeature{Letters=ResetAll,LetterSpace=0,Scale=0.9}\itshape The Invisible Man Loses His Temper}
\begin{ChapterStart}
\vspace*{2\nbs}

\ChapterTitle{CHAPTER\, TWELVE}
\vspace{1.5\nbs}
\ChapterSubtitle{The Invisible Man}
\vspace{0.75\nbs}
\ChapterSubtitle{Loses His Temper}
\end{ChapterStart}
...
{\addfontfeature{LetterSpace=-1.375}“Says he wi’ nart,” said Hall. “War n’t speakin’ to us, wuz he?”}\looseness=-1
