\label{ch:25}
\SetRectoHeadText{\addfontfeature{Letters=ResetAll,LetterSpace=0,Scale=0.9}\itshape The Hunting of the Invisible Man}
\begin{ChapterStart}
\vspace*{2\nbs}

\ChapterTitle{CHAPTER\, TWENTY-FIVE}
\vspace{1.5\nbs}
\ChapterSubtitle{The Hunting of the}
\vspace{0.75\nbs}
\ChapterSubtitle{Invisible Man}
\end{ChapterStart}

\dropcap[lines=2]{F}\kern-4pt\textsc{or a space} Kemp was too inarticulate to make Adye understand the swift things that had just happened. They stood on the landing, Kemp speaking swiftly, the grotesque swathings of Griffin still on his arm. But presently Adye began to grasp something of the situation.
